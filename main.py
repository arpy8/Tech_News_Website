...
st.markdown("""<style> #MainMenu {visibility: hidden;} footer {visibility: hidden;} </style> <h1 style='text-align: center; color: red;'>🔥 Today's top 10 news in Tech 🔥</h1> <h6 style='text-align: center; color: grey;'>(built under 10 loc)</h6> <hr>""", unsafe_allow_html=True)
for i in range(10):
